      ...
      <div className="flex flex-col gap-4 items-center">
        <div className="flex items-center gap-1 w-full justify-center mt-[66px] relative">
          <form className="flex items-center w-full gap-1 justify-center">
            ...
            <button
              type="submit"
              className="absolute text-text md:ml-[70%] ml-[75%]"
            >
              <BsSearch />
            </button>
          </form>
        </div>
        <div className="h-auto py-12 flex justify-center items-center md:w-[75.15%] sm:w-[80.15%] w-[90.15%] md:h-[187.58px] bg-primary text-white rounded-tl-none rounded-bl rounded-tr-none rounded-br">
