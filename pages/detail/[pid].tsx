...
import { MdBookmarkRemove, MdDeleteForever } from 'react-icons/md'
import {
  AiFillDislike,
  AiFillEdit,
  AiFillLike,
...
//   }
// }[]
const Detail = ({ pst, recommend }: { pst: Data; recommend: Reco }) => {
  ...
  async function handleClick(id: string) {
    //@ts-ignore
    await instance.delete('/post/deleteComment', { data: { id } })
    fetchComments()
  }
  ...
  async function handleUpdateSubmit(id: string) {
    console.log(id)
    // let dataToSend = {
    //   id: user.id,
    //   name: cname,
...
export async function getServerSideProps(router: NextRouter) {
  ...
  return { props: { pst: data, recommend: d } }
}
